...
# create time array and control parameter array r of the data
# start_time = 0.
# end_time = 2000.
# samples = 30000
...
# noise_grid = np.linspace(0,0.5, n_noise_grid_points)

# #load data
# data = np.load('./tutorial_data/ts_fold_sigma0.25dynamic.npy')
# Langevin_estimation_obj = Langevin_estimation(data, time)
# print(Langevin_estimation_obj.ndim)
# , prior_range = np.array([[20,-20],[20,-20],[20,-20],[20,-20],[20,0]]), prior_type = 'Flat Prior')
# # print(Langevin_estimation_obj.prior_range)
# # Langevin_estimation_obj.perform_driftslope_noise_window_scan(window_size, window_shift, slope_grid, 
# # 															noise_grid, nsteps = nsteps, print_AC_tau = False, 
# # 															ignore_AC_error = True, thinning_by = 60, 
# # 															print_progress = True, create_animation = True, 
# # 															mark_critical_point = 1500, mark_noise_level = 0.25, animation_title = 'Test animation')

# Langevin_estimation_obj = Langevin_estimation(data,time)
# Langevin_estimation_obj.perform_driftslope_noise_window_scan(window_size, window_shift, slope_grid, noise_grid)

# print(Langevin_estimation_obj.slope_storage)
# print(Langevin_estimation_obj.noise_level_storage)
